...
if (isset($_SESSION['user'])) {
	...
	$row = $stmt->fetch();
	$cartbutton = '';
	if ($row['product_id'] == $product['prodid']) {
		$cartbutton =  '<button type="button" class="flex-c-m sizefull bg1 bo-rad-23 hov1 s-text1 trans-0-4">
									Added
								</button>';
	}else{
		$cartbutton = '<button type="submit" onclick="myFunction3()" id="add-to-cart"  class="flex-c-m sizefull bg1 bo-rad-23 hov1 s-text1 trans-0-4">
									Add to Cart
								</button>';
	}
					...
					<div class="flex-r-m flex-w p-t-10">
						<div class="w-size16 flex-m flex-w">
							...
							<div class="btn-addcart-product-detail size9 trans-0-4 m-t-10 m-b-10">
															<button type="submit" onclick="myFunction3()" id="add-to-cart"  class="flex-c-m sizefull bg1 bo-rad-23 hov1 s-text1 trans-0-4">
									Add to Cart
								</button>
							</div>
							<div id="snackbar">
...
foreach ($stmt as $row12) {
?>
					<div class="item-slick2 p-l-15 p-r-15">
						<!-- Block2 -->
						<div class="block2">
							<div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelnew">
								<img src="<?php echo (!empty($row12['photo'])) ? 'images/allproduct/' . $row12['photo'] : 'images/noimage.jpg'; ?>"  alt="IMG-PRODUCT">
...
<!--===============================================================================================-->
	...
	<script>
	  ...
	  <?php include 'includes/essence_script.php'; ?></body>
</html>
