      ...
      <div class="modal-body">
        <form class="form-horizontal" method="POST" action="users_edit.php">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <textarea class="form-control" id="edit_address" name="address" style="background: none;border-bottom: 1px solid white;border-top: none;border-left: none;border-right: none;color: white"></textarea>
            </div>
          </div>
          <div class="form-group">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title"><b>Add New DeliveryBoy</b></h4>
      </div>
      <div class="modal-body">
        <form class="form-horizontal" method="POST" action="adddeliverboy.php" enctype="multipart/form-data">
          <div class="form-group">
            <label for="email" class="col-sm-3 control-label">Email</label>
